...
This is a helper app to be used in conjunction with the [File I/O Scratch Extension](https://github.com/Znapi/scratchx-file-io/).

[**Download**](https://github.com/Znapi/scratchx-file-io-app/releases/download/v1.2/file-io-helper-app.jar) (Runnable JAR file)
